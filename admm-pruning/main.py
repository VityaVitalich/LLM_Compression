...
def main():
    ...
    parser.add_argument('--outlier_fraction', type=float, default=0, help='fraction of outliers in the original weight matrices')
    ...
    if args.save_model:
        ...
        print(f'model has been saved in {args.save_model}')
