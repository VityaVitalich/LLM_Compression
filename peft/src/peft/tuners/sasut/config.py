...
@dataclass
class SASUTConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`SASUTModel`].

    Args:
       TODO: add args
    """

    outlier_num: int = field(default=128, metadata={"help": "Number of outliers to learn"})
    ...
    noise_type: str = field(
        ...
        metadata={
            "help": (
                "Add quantization noise to the forward of the model"
            )
        },
    )
    compute_quant_scale: bool = field(default=True, 
        metadata={
            "help": (
