...
def model_configs():
    ...
    data.dataset_name = "allenai/tulu-v2-sft-mixture" #"ostapeno/tulu_v2_flan_v2_subset"
    ...
    config.output_dir = './exp_results/instruct/llama_quik3bit_transformers_sft_mixture_only_fp'
