...
def model_configs():
    ...
    config.output_dir = '/home/exp_results/instruct/llama_quik4bit_normal_noise_acc_step_div2'

    ### TRAINING ###
    config.run_name = 'noise_4bit'
    ...
    config.loading_quik_quant_weight = {
        'load_weight': False,
        'path_to_quant_params': '/home/llm_compression/Quantization/Quik/weights/llama7b_3w_16a_quant_params/quant_params.pt',
