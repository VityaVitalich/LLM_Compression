...
def run_train(
    ...
    model._modules['lm_head']._parameters['weight'].requires_grad = True

    # model._modules['model']._modules['layers']._modules['0']._modules['input_layernorm']._parameters['weight'].requires_grad = True
...
def main():
    ...
    model_args = ModelArguments(
        model_name_or_path = "/home/projects/LLaMA/huggingface/Llama-2-7b-hf",
        config_name = "/home/projects/LLaMA/huggingface/Llama-2-7b-hf/config.json",
        tokenizer_name = "/home/projects/LLaMA/huggingface/Llama-2-7b-hf",
