...
if __name__ == '__main__':
    ...
    for item in os.listdir(parent_directory):
        ...
        if os.path.isdir(item_path) and item.startswith(prefix):
             ...
             command = f'lm_eval --model hf     --model_args pretrained={item_path} \
        --tasks hellaswag,swag,winogrande,boolq,xwinograd_en    --device cuda:0     --batch_size 16  --output_path {result_path}'
             os.system(command)
