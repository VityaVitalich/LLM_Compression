...
#SBATCH --output=zh_logs/svd_thr.txt
#SBATCH --time=1-00
...
srun singularity exec --bind /trinity/home/v.moskvoretskii/:/home -f --nv /trinity/home/v.moskvoretskii/images/compression.sif bash -c '
    ...
    nvidia-smi;
    pip list;
    python threshold_svd.py --model meta-llama/Llama-2-7b-hf --token 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 --n_components 1024 --save_dir /home/cache/
'
