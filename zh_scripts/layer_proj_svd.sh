...
srun singularity exec --bind /trinity/home/v.moskvoretskii/:/home -f --nv /trinity/home/v.moskvoretskii/images/compression.sif bash -c '
    ...
    cd /home/LLM_Compression/sensitivity;
    nvidia-smi;
    pip list;
    python layer_proj_svd.py --model meta-llama/Llama-2-7b-hf --token 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 --n_components 1024 --save_dir /home/cache/llama7b_svd/
'
